 ...
 */
exports.getPasswordsCurrentStatus = (0, __1.endpoint)({
    method: 'GET',
    path: '/v2/passwords/current-status',
    baseUrl: 'https://auth.roblox.com',
    requestFormat: 'json',
    response: zod_1.z.object({ valid: zod_1.z.boolean() }),
    errors: [
        {
            status: 401,
            description: `0: Authorization has been denied for this request.`,
 ...
 * @param Ticket
 */
exports.getPasswordsReset = (0, __1.endpoint)({
    method: 'GET',
 ...
 */
exports.postPasswordsReset = (0, __1.endpoint)({
    method: 'POST',
    path: '/v2/passwords/reset',
    baseUrl: 'https://auth.roblox.com',
    requestFormat: 'json',
 ...
 */
exports.postPasswordsResetSend = (0, __1.endpoint)({
    method: 'POST',
 ...
 */
exports.postPasswordsResetVerify = (0, __1.endpoint)({
    method: 'POST',
